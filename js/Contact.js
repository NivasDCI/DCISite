...
function SendEmail() {
    ...
    let finalmessage = `Dear DCI, 
                        ...
                        I hope this message finds you well. We are reaching out from ${company} to express our keen intrest in
                        working with your esteemed organized .Having reviewed your seervices/products, we are impressed with your reputation
                        for excellence and believe there is grate synergy between our bussiness.
                        
                        we look forword to the opportunity to collabrate with you and explore how we can work together to achive mutual success.
                         Pleace let us know a convenient time to discuss further or schedule a meeting. 
