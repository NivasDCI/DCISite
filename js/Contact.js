...
function SendEmail() {
    ...
    let finalmessage = `let finalmessage = `Dear DCI, 


I hope this message finds you well. We are reaching out from ${company} to express our keen intrest in working with your estemed organized .Having reviewed your services/products, we are impressed with your reputation for excellence and believe there is grate synergy between our bussiness.
